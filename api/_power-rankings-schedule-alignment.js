...
function buildAlignedRaceRow(race, match, winnerDriverId, alignmentMethod, alignmentMismatchWarning) {
  return {
    ...
    driverResults: match?.driverResults || {},
    officialStarterCount: match?.officialStarterCount ?? null,
    provisionalCount: match?.provisionalCount ?? 0,
    totalScoredFieldCount: match?.totalScoredFieldCount ?? null,
    provisionalDriverIds: match?.provisionalDriverIds || [],
