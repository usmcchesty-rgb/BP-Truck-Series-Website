...
export const MISSION_CONTROL_TASKS = [
  ...
  {
    id: 'sun-prepare-next-race-salaries',
    workflow: 'postRace',
    raceRole: 'completed',
    day: 'sunday',
    dayLabel: 'Sunday',
    title: 'Prepare next-race fantasy salary draft',
    description: 'Auto-generate the next race salary draft after fantasy scoring completes.',
    href: '/admin/fantasy.html#post-race-automation',
  },
  {
    id: 'sun-review-provisional-ledger',
    workflow: 'postRace',
    raceRole: 'completed',
    day: 'sunday',
    dayLabel: 'Sunday',
    title: 'Review provisional ledger',
    description: 'Confirm official SimRacerHub provisionals are synced to the BP ledger.',
    href: '/admin/competition?tab=provisionals',
  },
  {
...
const TASK_DETECTION_MODES = {
  ...
  'sun-prepare-next-race-salaries': DETECTION_MODES.AUTOMATIC,
  'sun-review-provisional-ledger': DETECTION_MODES.AUTOMATIC,
